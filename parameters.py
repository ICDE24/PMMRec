...
def parse_args():
    ...
    # ============== fushion methods ==============
    parser.add_argument("--fusion_method", type=str, default="weight_sum", choices=['co_att', 'merge_attn','sum', 'concat', 'film', 'gated', "weight_sum"])
    ...
    parser.add_argument("--UI_alpha", type=float, default=0.4)
    parser.add_argument("--UI_temp", type=float, default=0.1)
