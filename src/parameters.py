...
def parse_args():
    ...
    # ============== data_dir ==============
    parser.add_argument("--mode", type=str, default="transfer", choices=['TFS', 'transfer'])
    ...
    # ============== fushion methods ==============
    parser.add_argument("--fusion_method", type=str, default="weight_sum", choices=['co_att', 'merge_attn','sum', 'concat', 'film', 'gated'])
    ...
    parser.add_argument("--pretrain_part", type=str, default="item_encoder", choices=['item_encoder', 'user_encoder', "full"])
    
    parser.add_argument("--pretrain_load_ckpt_name", type=str, default=None)
